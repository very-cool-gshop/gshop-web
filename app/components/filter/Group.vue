...
watch(
    () => route.query,
    (value) => (Object.keys(value).length === 0 ? (filtersKey.value += 1) : null),
    { deep: true },
)
</script>
        ...
        <div class="lg:sticky lg:top-24">
            <div class="flex justify-between items-center mb-4">
                ...
                <div v-if="quantity" class="relative">
                    <UButton variant="ghost" color="primary" class="ms-4" label="Clear Filters" @click="resetFilters" />
            ...
            <UAccordion :key="filtersKey" :items="filters" type="multiple">
                <template #body="{ item }">
